...
public class EclipticCoordinatesTest {
    ...
    void ofWorksOnEdgeCases() {
        Assertions.assertEquals(179.9999999, EclipticCoordinates.of(Angle.ofDeg(179.9999999), Angle.ofDeg(90.0)).lonDeg(), 1e-9);
        Assertions.assertEquals(-90.0, EclipticCoordinates.of(Angle.ofDeg(0.0), Angle.ofDeg(-90.0)).latDeg(), 1e-9);
        Assertions.assertEquals(90.0, EclipticCoordinates.of(Angle.ofDeg(90.0), Angle.ofDeg(0.0)).lonDeg(), 1e-9);
    }
