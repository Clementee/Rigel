...
public class EquatorialCoordinatesTest {
    ...
    void ofWorksOnEdgeCases() {
        Assertions.assertEquals(179.9999999, EquatorialCoordinates.of(Angle.ofDeg(179.9999999), Angle.ofDeg(90.0)).raDeg(), 1e-9);
        Assertions.assertEquals(-90.0, EquatorialCoordinates.of(Angle.ofDeg(0.0), Angle.ofDeg(-90.0)).decDeg(), 1e-9);
        Assertions.assertEquals(90.0, EquatorialCoordinates.of(Angle.ofDeg(90.0), Angle.ofDeg(0.0)).raDeg(), 1e-9);
    }
