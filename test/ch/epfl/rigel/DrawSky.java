...
public final class DrawSky extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try (InputStream hs = resourceStream("/hygdata_v3.csv"); InputStream is = resourceStream("/asterisms.txt"); InputStream cs = resourceStream("/constellations.txt")) {

            StarCatalogue catalogue = new StarCatalogue.Builder()
                    .loadFrom(hs, HygDatabaseLoader.INSTANCE).loadFrom(is, AsterismLoader.INSTANCE).loadFrom(cs, ConstellationLoader.INSTANCE).build();
            ...
            painter.clear();
            painter.drawStars(sky, projection, planeToCanvas, true, true);
