...
public final class Angle {
    ...
    private final static int SEC_PER_DEG = 360;
     ...
     * @return (double) : the angle in radians belonging to the interval
     *         [0,2*pi]
     */
    ...
    /**
     * Method allowing to convert an angle from seconds to radians(and normalize
     * it)
     * 
     * @param sec
     *            (double) : the angle in seconds
     ...
     * @param min
     *            (int) : the number of minutes in the interval [0,60[
     * @param sec
     *            (double) : the number of seconds in the interval [0,60[
     * @return (double) : the normalized angle in radians
     */
    public static double ofDMS(int deg, int min, double sec) {
        if (min <= 0 || min > 60 || sec <= 0 || sec > 60) {
            ...
            double angle = deg + ofArcsec(min * MIN_TO_SEC + sec);
