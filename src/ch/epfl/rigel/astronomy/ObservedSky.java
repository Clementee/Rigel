...
public class ObservedSky {
     ...
     * @return catalogue.asterisms() (Set<Asterism>) : return the set of asterims
     */
    public Set<Asterism> asterism(){ return Set.copyOf(catalogue.asterisms()); }
     ...
     */
    private static double distance(CartesianCoordinates o1, CartesianCoordinates o2){ return Math.hypot(o1.x()-o2.x(), o1.y()- o2.y()); }
